...
export default function Location() {
  return (
    <section id="details" className="mt-16 py-16 pt-[100px] bg-light-green flex flex-col gap-20 items-center justify-center rounded-tl-full rounded-tr-full px-12 relative overflow-hidden max-w-[1440px] xl:mx-auto 2xl:overflow-visible">
      ...
      {/* flowers */}
      <div className='hidden md:block absolute bottom-0 left-0 lg:-left-10 2xl:-left-22'>
      ...
      <div className='hidden md:block absolute bottom-0 right-0 lg:-right-10 2xl:-right-28'>
